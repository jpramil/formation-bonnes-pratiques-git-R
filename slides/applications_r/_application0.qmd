...
2. Lancer un service `RStudio`. Dans l'onglet de configuration `Git` du service, fixer la durée du `Cache` pour le stockage des identifiants `GitLab` à une valeur suffisamment élevée. De plus, augmenter la `Persistence` à 10Gi (pour la suite).
